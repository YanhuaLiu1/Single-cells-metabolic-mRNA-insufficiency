...
for i = 1:6
    ...
    allowed_IDs = {'EX_arg_L[e]'; 'EX_cys_L[e]'; 'EX_his_L[e]';'EX_ile_L[e]';...
                'EX_leu_L[e]'; 'EX_lys_L[e]'; 'EX_met_L[e]'; 'EX_phe_L[e]';...
                'EX_thr_L[e]'; 'EX_trp_L[e]'; 'EX_tyr_L[e]';'EX_val_L[e]'; 'EX_chol[e]';...
                'EX_pnto_R[e]'; 'EX_fol[e]';'EX_ncam[e]'; 'EX_pydxn[e]'; 'EX_ribflv[e]'; ...
                'EX_thm[e]'; 'EX_inost[e]';'EX_ca2[e]';'EX_cl[e]'; 'EX_mg2[e]';...
                'EX_so4[e]'; 'EX_k[e]'; 'EX_na1[e]'; 'EX_hco3[e]'; ...     
                'EX_pi[e]'; 'EX_h2o[e]'; 'EX_o2[e]';'EX_co2[e]'}; 
    allowed_lbs = -1*[0.5972; 0.099; 0.2; 0.3969;...
         0.3969; 0.3989; 0.1007; 0.1939;... 
         0.4034; 0.0490; 0.1992; 0.3932; 0.0071;...
        0.0021; 0.0023; 0.0082; 0.0049; 0.00027;...
        0.0030; 0.0111; 1.8039; 124.4; 0.8139;...
        0.8139; 5.3333; 143.4318; 26.1905;...
        1.0145; 1000; 1000; 1000];
